            ...
            <div class="modal-body">
                ...
                <form method="POST" action="stock.php?<?= http_build_query($filters) ?>" data-validate novalidate>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group"><label>Current Quantity *</label><input type="number" step="1" min="0" max="500" name="current_qty" value="<?= (int)$editItem['current_qty'] ?>" required><span class="field-error"></span></div>
                        <div class="form-group"><label>Min Threshold *</label><input type="number" step="1" min="0" max="500" name="min_threshold" value="<?= (int)$editItem['min_threshold'] ?>" required><span class="field-error"></span></div>
                    </div>
                    <div class="modal-footer"><a href="<?= $cancelUrl ?>" class="btn btn-secondary">Cancel</a><?= csrf_field() ?><button type="submit" class="btn btn-primary">Save</button></div>
                </form>
            </div>
        </div>
    </div>

        ...
        <div class="mobile-topbar">
            ...
            <div class="mobile-topbar-avatar"><?= strtoupper(substr($_SESSION['username'] ?? 'U', 0, 1)) ?></div>
        </div>
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li><a href="../storefront/index.php" <?= $activePage === 'store' ? 'class="active"' : '' ?>><i class="fa-solid fa-store"></i> Store</a></li>
            ...
            <div class="sidebar-user">
                ...
                <div class="user-info">
                    <div class="user-name"><?= safe($_SESSION['username'] ?? 'Guest') ?></div>

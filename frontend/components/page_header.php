        ...
        ?>
            <div class="page-header<?= !empty($headerAction) ? ' page-header-with-action' : '' ?>">
                ...
                <?php if (!empty($headerAction)): ?>
                    ...
                    <a href="<?= $headerAction['href'] ?>" class="btn btn-primary"><?= $headerAction['label'] ?></a>
                    <?php elseif (isset($headerAction['onclick'])): ?>
                    <button class="btn btn-primary" onclick="<?= $headerAction['onclick'] ?>"><?= $headerAction['label'] ?></button>
                    <?php endif; ?>
                <?php endif; ?>
            </div>